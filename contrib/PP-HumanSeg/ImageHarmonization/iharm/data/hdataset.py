...
class HDataset(BaseHDataset):
    def __init__(self, dataset_path, split, blur_target=False, **kwargs):
        ...
        images_lists_paths = [
            x for x in self.dataset_path.glob('*.txt') if x.stem.endswith(split)
        ]
    ...
    def get_sample(self, index):
        ...
        composite_image_path = str(
            self._composite_images_path / composite_image_name)
        ...
        return {
            ...
            'object_mask': object_mask,  # [h,w], 0 or 1, float32
